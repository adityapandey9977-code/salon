...
router.post('/events/appointment-created', async (req, res, next) => {
    try {
...
router.post('/events/stock-low', async (req, res, next) => {
    try {
...
router.post('/telephony/inbound-call', async (req, res, next) => {
    try {
