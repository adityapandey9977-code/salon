...
export class StockRepository {
    ...
    async listBranchStock(tenantId, branchId) {
    ...
    async getCriticalStockAlerts(tenantId) {
        const stocks = await prisma.branchStock.findMany({
            where: { tenantId },
            include: {
                sku: true,
    ...
    async updateStockProjection(tenantId, branchId, skuId, deltaQty, reorderLevel, reorderQuantity) {
    ...
    // Stock Batches
    async listBatches(tenantId, branchId, skuId) {
    ...
    async updateBatchRemaining(id, deltaQty) {
    ...
    // Reorder Rules
    async listReorderRules(tenantId, branchId) {
