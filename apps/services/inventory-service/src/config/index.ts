...
const ConfigSchema = z.object({
  ...
  PORT: z.coerce.number().default(6008),
  INVENTORY_DATABASE_URL: z
    .string()
    .default('postgresql://postgres:postgres@localhost:5432/inventory_db?schema=public'),
...
export const config: Config = ConfigSchema.parse({
  ...
  PORT: process.env.INVENTORY_SERVICE_PORT || 6008,
  INVENTORY_DATABASE_URL: process.env.INVENTORY_DATABASE_URL,
