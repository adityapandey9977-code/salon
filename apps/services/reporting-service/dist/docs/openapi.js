export const reportingOpenApiSpec = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'Read-optimized analytics projections, multi-tenant dashboards, branch comparisons, franchise metrics, operational reporting, async exports, and append-only audit trail.',
    },
    servers: [
        {
