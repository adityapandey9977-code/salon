...
export class MetricsRepository {
  public static async upsertDailyBranchMetrics(data: {
    tenantId: string;
    branchId: string;
    metricDate: Date;
  ...
  public static async upsertTenantDailyMetrics(data: {
    tenantId: string;
    metricDate: Date;
    branchCount?: number;
  ...
  public static async upsertStaffPerformanceDaily(data: {
    tenantId: string;
    branchId: string;
    employeeId: string;
    metricDate: Date;
  ...
  public static async upsertFranchiseDailyMetrics(data: {
    tenantId: string;
    franchiseId: string;
    metricDate: Date;
    grossSalesInc?: number;
  ...
  public static async upsertInventoryDailyMetrics(data: {
    tenantId: string;
    branchId: string;
    metricDate: Date;
  ...
  public static async upsertCallCenterDailyMetrics(data: {
    tenantId: string;
  ...
  public static async getBranchMetrics(tenantId: string, branchId?: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.DailyBranchMetricsWhereInput = { tenantId };
    if (branchId) where.branchId = branchId;
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
      if (endDate) where.metricDate.lte = endDate;
    }
  ...
  public static async getTenantMetrics(tenantId: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.TenantDailyMetricsWhereInput = { tenantId };
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
      if (endDate) where.metricDate.lte = endDate;
  ...
  public static async getStaffMetrics(tenantId: string, branchId?: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.StaffPerformanceDailyWhereInput = { tenantId };
    if (branchId) where.branchId = branchId;
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
  ...
  public static async getFranchiseMetrics(tenantId: string, franchiseId: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.FranchiseDailyMetricsWhereInput = { tenantId, franchiseId };
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
      if (endDate) where.metricDate.lte = endDate;
  ...
  public static async getInventoryMetrics(tenantId: string, branchId?: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.InventoryDailyMetricsWhereInput = { tenantId };
    if (branchId) where.branchId = branchId;
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
  ...
  public static async getCallCenterMetrics(tenantId: string, startDate?: Date, endDate?: Date) {
    const where: Prisma.CallCenterDailyMetricsWhereInput = { tenantId };
    if (startDate || endDate) {
      where.metricDate = {};
      if (startDate) where.metricDate.gte = startDate;
      if (endDate) where.metricDate.lte = endDate;
  ...
  public static async getSuperAdminPlatformMetrics() {
