...
export class PaymentService {
  public async createIntent(
    ...
    const cached = await idempotencyStore.getResult<PaymentIntentDto>(tenantId, data.idempotencyKey);
  ...
  public async getIntentById(tenantId: string, id: string): Promise<PaymentIntentDto> {
