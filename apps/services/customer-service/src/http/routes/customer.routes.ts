...
router.get(
  ...
  customerController.getDormant.bind(customerController),
);
...
router.get(
  '/:id/notes',
  requirePermission('customer.note.read'),
...
router.get(
  '/:id/cautions',
  requirePermission('customer.caution.read'),
  cautionController.getCautions.bind(cautionController),
);
router.post(
  '/:id/cautions',
  requirePermission('customer.caution.manage'),
  cautionController.addCaution.bind(cautionController),
);
router.patch(
  '/:id/cautions/:cautionId',
  requirePermission('customer.caution.manage'),
  cautionController.updateCaution.bind(cautionController),
);
