...
export class PayrollService {
    payrollRepo;
    commRepo;
    constructor(payrollRepo = new PayrollRepository(), commRepo = new CommissionRepository()) {
    ...
    async executePayrollRun(tenantId, data) {
    ...
    async approvePayrollRun(tenantId, id, approvedByUserId) {
