...
export class FinanceController {
    ...
    static async getCorporateKpis(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
            res.json({
                success: true,
    ...
    static async getCashflowTrend(req, res, next) {
        try {
            res.json({
                success: true,
                data: [
    ...
    static async getProfitabilityMatrix(req, res, next) {
        try {
            res.json({
                success: true,
                data: {
    ...
    static async getGstReturn(req, res, next) {
        try {
            res.json({
                success: true,
                data: {
    ...
    // Journals
    static async listJournals(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
    ...
    static async postJournal(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
            const journal = await journalService.postJournal(tenantId, req.body);
    ...
    static async getCommissionTiers(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
    ...
    static async updateCommissionTiers(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
    ...
    static async getStaffCommissions(req, res, next) {
        try {
            const tenantId = FinanceController.getTenantId(req);
