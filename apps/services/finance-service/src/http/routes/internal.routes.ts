...
router.post('/events/sale-completed', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/events/refund-completed', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/events/goods-received', async (req: Request, res: Response, next: NextFunction) => {
  try {
