...
router.post('/refresh-token', (req, res, next) =>
  tenantAuthController.refreshToken(req, res, next),
);
...
router.get('/me', authMiddleware, (req, res, next) =>
  tenantAuthController.getMe(req, res, next),
);
router.post('/logout', authMiddleware, (req, res, next) =>
  tenantAuthController.logout(req, res, next),
);
router.get('/sessions', authMiddleware, (req, res, next) =>
  tenantAuthController.getSessions(req, res, next),
);
