...
const ConfigSchema = z.object({
  ...
  PORT: z.coerce.number().default(6011),
  PLATFORM_DATABASE_URL: z
    .string()
    .default('postgresql://postgres:postgres@localhost:5432/platform_db?schema=public'),
...
export const config: Config = ConfigSchema.parse({
  ...
  PORT: process.env.PLATFORM_SERVICE_PORT || 6011,
