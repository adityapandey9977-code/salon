...
export class SubscriptionService {
    ...
    planRepo;
    cache;
    constructor(subRepo = new SubscriptionRepository(), planRepo = new PlanRepository(), cache = new PlatformReadStore()) {
    ...
    async getSubscriptionByTenantId(tenantId) {
        ...
        if (!sub)
            throw new NotFoundError(`Subscription for tenant ${tenantId} not found`);
    ...
    async removeOverride(tenantId, featureId) {
