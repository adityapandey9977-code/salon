export const bookingOpenApiSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description:
      'Production Booking & Scheduling Engine microservice owning appointments, line items, status lifecycles, availability slots, Redis locking, holds, waitlist, and walk-ins.',
  },
