...
export class RosterService {
    async queryRoster(tenantId, params) {
    ...
    async getEmployeeRosterForDate(tenantId, employeeId, dateStr) {
    ...
    async createRoster(tenantId, data, assignedByUserId) {
    ...
    async updateRoster(tenantId, id, data, updatedByUserId) {
