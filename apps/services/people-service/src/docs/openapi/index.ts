export const peopleOpenApiSpec = {
  ...
  info: {
    ...
    description:
      'Enterprise Employee Records, Staff Professional Profiles, Branch Assignments, Skills Catalogue, Shifts, Master Rostering, Geolocation Clock-In Attendance & Leave Management',
    version: '1.0.0',
    contact: {
