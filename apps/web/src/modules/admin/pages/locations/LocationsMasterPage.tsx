...
import { AllBranchesTab } from './AllBranchesTab';
...
export function LocationsMasterPage() {
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="font-serif text-[26px] text-ink font-semibold tracking-tight">
              Brand Locations &amp; Branch Network
            </h1>
            <p className="text-[13px] text-muted mt-0.5">
              Comprehensive control plane for branch performance, comparative benchmarking, working
              envelopes, and holiday schedules.
            </p>
          </div>
        </div>
          ...
          {[
            ...
            return (
              <button
                ...
                className={cn(
                  'flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer border select-none whitespace-nowrap shrink-0',
                  isActive
