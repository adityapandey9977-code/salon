...
import { BranchSettlementTab } from '../../admin/pages/finance/BranchSettlementTab';
import { CommissionsTab } from '../../admin/pages/finance/CommissionsTab';
import { FinancialAlertsAuditTab } from '../../admin/pages/finance/FinancialAlertsAuditTab';
import { FinancialOverviewTab } from '../../admin/pages/finance/FinancialOverviewTab';
import { FinancialReportsTab } from '../../admin/pages/finance/FinancialReportsTab';
import { GstTaxVisibilityTab } from '../../admin/pages/finance/GstTaxVisibilityTab';
import { ProfitabilityLiabilityTab } from '../../admin/pages/finance/ProfitabilityLiabilityTab';
import { RefundsCreditsTab } from '../../admin/pages/finance/RefundsCreditsTab';
import { RevenueCollectionsTab } from '../../admin/pages/finance/RevenueCollectionsTab';
import { TransactionsTab } from '../../admin/pages/finance/TransactionsTab';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-1.5 text-xs text-soft mb-1 font-medium">
            ...
            <span className="text-ink font-semibold">Financials &amp; Stock</span>
            <ChevronRight className="w-3.5 h-3.5 text-muted" />
          ...
          <h1 className="font-serif text-[26px] font-bold text-ink tracking-tight flex items-center gap-2.5">
            ...
            <span>Franchise Financial Control &amp; Analytics</span>
          </h1>
          <p className="text-xs text-muted mt-0.5 max-w-3xl">
            Centralized financial oversight for master franchise partners across all 4 franchise
            outlets—monitoring gross revenue, realized collections, transaction auditability, refund
            controls, staff commissions, branch settlements, profitability margins, and package
            breakage liability.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="px-3.5 py-2 bg-white rounded-2xl border border-purple-100/80 shadow-3xs flex items-center gap-2.5">
            ...
            <div>
              ...
              <strong className="text-xs font-bold text-ink">4 Active Outlets</strong>
            </div>
          </div>
        </div>
      </div>
