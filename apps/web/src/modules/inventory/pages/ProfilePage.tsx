    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-line pb-4">
        <h1 className="text-2xl font-serif font-bold text-ink tracking-tight">
          Storekeeper Profile & Account Security
        </h1>
        <p className="text-xs text-soft mt-1">
          Warehouse storekeeper credentials, warehouse permissions, shift status, and password
          security management.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Left Column: Storekeeper Badge & Security Status */}
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-2xl border border-line shadow-sm space-y-4 text-center">
            ...
            <div>
              <h2 className="text-base font-bold text-ink">Vikram Kulkarni</h2>
              <p className="text-xs text-purple-700 font-semibold">Head Inventory Storekeeper</p>
              <p className="text-[11px] text-soft mt-1">Employee ID: STK-801 • Central Warehouse</p>
            </div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-line shadow-sm space-y-3">
            <div className="flex items-center gap-2 text-xs font-bold text-ink">
              ...
              Warehouse Authorization Status
            </div>
            ...
            <div className="p-3 bg-emerald-50/70 border border-emerald-200 rounded-xl space-y-1 text-xs">
              ...
              <div className="text-[11px] text-emerald-700">Last changed: 15 days ago</div>
            </div>
            ...
            <div className="text-[11px] text-soft space-y-1.5 pt-1">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-ink">Warehouse Desk #1</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white p-5 rounded-2xl border border-line shadow-sm space-y-3">
            <h3 className="text-sm font-bold text-ink">Monthly Storekeeper Performance</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-1">
              <div className="p-3 bg-purple-50 rounded-xl text-center">
                <div className="text-xs text-purple-700 font-semibold">GRN Shipments</div>
                <div className="text-xl font-bold text-purple-900">24 Received</div>
              </div>
              <div className="p-3 bg-emerald-50 rounded-xl text-center">
                <div className="text-xs text-emerald-700 font-semibold">Stock Audit Diff</div>
                <div className="text-xl font-bold text-emerald-900">0.02% Var</div>
              </div>
              <div className="p-3 bg-indigo-50 rounded-xl text-center">
                <div className="text-xs text-indigo-700 font-semibold">Stock Valuation</div>
                <div className="text-xl font-bold text-indigo-900">₹12,45,000</div>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2 border-b border-line pb-3">
              ...
              <div>
                ...
                <p className="text-xs text-soft">
                  Update your login password to maintain warehouse authorization security.
                </p>
              </div>
            </div>
          ...
          {/* Scope Permissions */}
          <div className="bg-white p-5 rounded-2xl border border-line shadow-sm space-y-3">
            <h3 className="text-sm font-bold text-ink">Storekeeper Desk Scope Permissions</h3>
            <div className="space-y-2 text-xs text-soft">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600" /> Master Product SKU & Barcode
                Setup Access
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600" /> Service Recipe (BOM) &
                Auto-Deduction Rules Configuration
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600" /> Goods Received Notes (GRN) &
                Expiry Entry Authority
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600" /> Physical Stocktake Audit
                Sign-off Rights
              </div>
            </div>
          </div>
