...
export function ClientSidebar() {
  ...
  const navGroups = [
    ...
    {
      group: 'BOOKINGS & SERVICES',
      items: [
        {
          path: '/services',
          label: 'Search Services',
          icon: <Search className="w-[13px] h-[13px]" />,
        },
        {
          path: '/appointments',
          label: 'Appointments',
      ...
      items: [
        {
          ...
          icon: <Gift className="w-[13px] h-[13px]" />,
          badge: (
        ...
        },
        {
          path: '/wallet',
          label: 'Wallet',
          icon: <Wallet className="w-[13px] h-[13px]" />,
          badge: (
      ...
      items: [
        {
          ...
          icon: <History className="w-[13px] h-[13px]" />,
        },
        {
          path: '/feedback',
        ...
        },
        {
          path: '/support',
          label: 'Support & Help',
          icon: <Headphones className="w-[13px] h-[13px]" />,
        },
      ],
    },
    {
        ...
        <div className="flex gap-[6px] items-center p-[2px_6px] justify-center lg:justify-start">
          ...
          {!effectiveCollapsed && (
            <>
              ...
              <button
                type="button"
                onClick={() => logout().then(() => { window.location.href = '/client/login'; })}
                title="Sign Out"
