    ...
    >
      ...
      {isOpen && (
        <div
          ...
          onMouseLeave={handleMouseLeave}
        >
          <div className="w-68 bg-white rounded-2xl shadow-[0_16px_40px_rgba(59,38,71,0.14)] border border-line/80 py-2">
            {categoryLabel && (
            ...
            {footerNote && (
              <div className="mt-1 px-3.5 pt-2 border-t border-line/40 text-[10px] text-muted font-medium">
                {footerNote}
              </div>
            )}
          </div>
